...
public class UserRequestDTO {
    @Schema(description = "Identificador único del usuario (se puede omitir al registrar)", example = "1")
    private Long id;
    ...
    @Schema(description = "Rol del usuario (ejemplo: 1=Admin, 2=Cliente)", example = "2")
    private Long idRol;
